...
- Operator to one node in your cluster using a Deployment
- Falco to all nodes in your cluster using a DaemonSet

Also provides all the configuration options provided by the original [stable/falco chart](https://github.com/helm/charts/tree/master/stable/falco).

For example, you can even create a deployment for generating Falco alerts for testing purpose.
