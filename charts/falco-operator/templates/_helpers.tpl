...
{{- .Release.Name | trunc 63 | trimSuffix "-" | printf "%s-falco" -}}
{{- else -}}
{{- printf "%s-%s-falco" .Release.Name $name | trunc 63 | trimSuffix "-" -}}
{{- end -}}
{{- end -}}
{{- end -}}
...
{{- if contains $name .Release.Name -}}
{{- .Release.Name | trunc 63 | trimSuffix "-" | printf "%s-operator" -}}
{{- else -}}
